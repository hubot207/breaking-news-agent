...
URLs are allowed in x posts. X bills more for URL posts (~$0.20 vs $0.015 for
plain text), but the reach from a clickable source link is worth the premium.
To revert to URL-stripping, restore _strip_urls() from git history (commit
b6cf7cb introduced it).
"""
